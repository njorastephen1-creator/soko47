...
`);
console.log('Created Jiji-style product card');
const grids = [
  ['src/routes/index.tsx', '<div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">', '<div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">'],
  ['src/routes/browse.tsx', '<div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">', '<div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">'],
  ['src/routes/shop.$slug.tsx', '<div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">', '<div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">']
];
for (const [file, oldS, newS] of grids) {
  ...
  if (content.includes(oldS)) {
    ...
    console.log('Patched grid in', file);
  } else console.log('WARNING: grid not found in', file);
}
console.log('DONE: jiji grid');