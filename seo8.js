...
export default async function handler(req, res) {
  ...
  // Humans get the full SPA (fetched from root)
  if (!isBot) {
    try {
      const r = await fetch("https://soko47-kenya.vercel.app/");
...
`);
console.log('api/og/[id].js updated (humans get SPA via fetch)');