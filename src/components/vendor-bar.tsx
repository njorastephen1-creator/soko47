  ...
  return (
    <div className="border-t border-primary/20 bg-primary/5">
      <div className="mx-auto flex max-w-7xl items-center gap-2 overflow-x-auto px-4 py-2 text-xs font-semibold">
        ...
        <Link to="/vendor" className="flex shrink-0 items-center gap-1 rounded-full bg-primary px-3 py-1 text-primary-foreground">Shop dashboard</Link>
        ...
        {vendor.subscription_plan === "pro" ? <Link to="/pro" className="flex shrink-0 items-center gap-1 rounded-full bg-accent/20 px-3 py-1 text-accent-deep">Pro Studio</Link> : null}
      </div>
    </div>
  );
}
